  ...
  return (
    <main className="relative z-10 flex min-h-screen items-center justify-center px-6 py-12 md:px-10 md:py-16">
      <div className="mx-auto w-full max-w-md rounded-none border border-border bg-card/90 p-10 backdrop-blur sm:p-12">
        ...
        <h1 className="mt-4 font-sans text-3xl font-bold tracking-tight">Log in</h1>
        <p className="mt-2 text-sm text-muted-foreground">Welcome back.</p>

        <form className="mt-12 space-y-7" onSubmit={handleLogin}>
          ...
          <div className="space-y-2.5">
            ...
            <Input id="login-password" type="password" placeholder="Enter your password" required minLength={8} />
          </div>
